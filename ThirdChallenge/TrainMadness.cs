...
namespace ThirdChallenge
{
    internal class TrainMadness
    {
        static void Main(string[] args)
        {
            ...
            sumOfCubicMeters = SumCubicMetersOfBoxes(boxes, ref tooBigBoxFlag);
            ...
            CheckFactibility(totalWagonsCubicCapacity, sumOfCubicMeters, tooBigBoxFlag);
        }

        private static void CheckFactibility(int totalWagonsCubicCapacity, double sumOfCubicMeters, bool tooBigBoxFlag)
        {
        ...
        private static double SumCubicMetersOfBoxes(List<Box> boxes, ref bool tooBigBoxFlag)
        {
